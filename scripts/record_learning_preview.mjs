...
const context=await browser.newContext({baseURL:'http://localhost:2740',viewport:{width:1600,height:1000},acceptDownloads:true,recordVideo:{dir:path.join(output,'raw'),size:{width:1600,height:1000}}});
